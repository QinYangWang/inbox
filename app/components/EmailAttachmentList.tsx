				...
				{files.map((attachment) => {
					...
					if (isImage && onPreviewImage) {
						return (
							<button
								...
								className="flex items-center gap-2 rounded-md border border-border px-3 py-2 transition-colors hover:bg-accent text-sm text-left"
							>
					...
					return (
						<a
							...
							className="flex items-center gap-2 rounded-md border border-border px-3 py-2 no-underline transition-colors hover:bg-accent text-sm"
						>
